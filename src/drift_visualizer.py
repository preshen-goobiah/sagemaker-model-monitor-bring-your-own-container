...
def plot_drift_score(drift_df, top_k=5):    
    ...
    __plot_top_k_drifts(drift_df, feature='drift_score', ylabel='Feature Drift Score (%)', top_k=5)
...
def plot_p_values(drift_df, top_k=5):
    ...
    __plot_top_k_drifts(df, feature='inv_log_p_value', ylabel='Inverse log p-value', top_k=5)
